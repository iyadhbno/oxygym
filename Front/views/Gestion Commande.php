...
foreach($listecommande as $row){
  ...
  <td><a href="modifiercommande.php?idP=<?PHP echo $row['idP']; ?>">
  Modifier</a></td>
  </tr>
  <?PHP
}
                   ...
                   -->
                    <form method="POST" action="ajoutercategorie.php">
                          <table>
                            ...
                            <tr>
                              <td>
                                <input type="email" id="email" class="email" name="nomC" required>
                      ...
                      <div class="modal-body mx-3">
                        ...
                        <form method="POST" action="ajouterproduit.php">
                          <table>
                            ...
                            <tr>
                              <td>
                                <input type="email" id="email" class="email" name="nomP" required>
